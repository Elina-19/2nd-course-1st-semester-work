...
<%@taglib prefix="t" tagdir="/WEB-INF/tags" %>
    ...
    <div class="col-md-8 add-chapter">
        ...
        <div id="message"></div>
        <div>
            <textarea class="form-control" id="description" placeholder="Рецензия" rows="3"></textarea>
        </div>
        <div class="row mt-4">
            <div class="col-md-4"><button id="button" class="btn" type="submit">Отправить</button></div>
        </div>
        </c:if>
    </div>
